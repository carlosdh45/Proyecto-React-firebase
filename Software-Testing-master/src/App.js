...
import LacteosIncidencias from './components/LacteosIncidencias';
...
function App() {
  return (
    ...
    <Switch>
        ...
        <GuardRoute type="private" path="/Lacteos" exact component={Lacteos} />
        ...
        <GuardRoute type="private" path="/LacteosIncidencias" exact component={LacteosIncidencias} />
